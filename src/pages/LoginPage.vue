...
const login = () => {
  if (username.value === 'Harshith' && password.value === 'pass') {
...
<template>
  <div class="flex flex-col gap-10 w-[100%] justify-center items-center h-screen">
    ...
    <form @submit.prevent="login" class="w-96">
      ...
      <p class="p pt-4">
        Don't have an account? <span class="span line-through">Sign Up</span>
